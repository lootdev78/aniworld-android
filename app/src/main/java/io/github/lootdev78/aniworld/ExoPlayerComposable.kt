            ...
            .pointerInput(playback.id) {
                ...
                detectVerticalDragGestures(
                    ...
                    onVerticalDrag = { change, dragAmount ->
                        ...
                        when (gestureMode ?: return@detectVerticalDragGestures) {
        ...
        if (gestureVisible) {
            Surface(color = Color.Black.copy(alpha = 0.72f), shape = androidx.compose.foundation.shape.RoundedCornerShape(16.dp)) {
                androidx.compose.foundation.layout.Row(
                    ...
                    Icon(if (displayedGestureMode == GestureMode.BRIGHTNESS) Icons.Default.Brightness6 else Icons.AutoMirrored.Filled.VolumeUp, null, tint = Color.White)
                    Text(
