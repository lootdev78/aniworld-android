...
class PlaybackService : MediaSessionService() {
    ...
    companion object {
        const val ACTION_PREVIOUS = "de.dxmoc.aniworld.action.PREVIOUS_EPISODE"
        const val ACTION_NEXT = "de.dxmoc.aniworld.action.NEXT_EPISODE"
        const val ACTION_STOPPED = "de.dxmoc.aniworld.action.PLAYBACK_STOPPED"
        private const val ACTION_PREPARE = "de.dxmoc.aniworld.action.PREPARE_PLAYBACK"
        private const val ACTION_STOP = "de.dxmoc.aniworld.action.STOP_PLAYBACK"
        private const val COMMAND_PREVIOUS = "de.dxmoc.aniworld.command.PREVIOUS_EPISODE"
        private const val COMMAND_NEXT = "de.dxmoc.aniworld.command.NEXT_EPISODE"
        private const val COMMAND_STOP = "de.dxmoc.aniworld.command.STOP_PLAYBACK"
